 ...
 *
 * This function initializes and configures the GPIO pins for button inputs, sets up  
 * interrupts to trigger on both edges, and registers the corresponding callback functions.  
 *
 * Steps performed:
